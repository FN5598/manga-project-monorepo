import ChaptersElement from "@shared/AdminPages/ChaptersElement";
import React, { useState } from "react";
import PublishButtons from "@shared/AdminPages/PublishButtons";
import { Search } from "lucide-react";
import { useDebounce } from "@hooks/useDebounce";
import { useFindChapterByNameQuery } from "@api/mangaApi";
...
export default function UploadChapter() {
  ...
  const { data: mangas } = useFindChapterByNameQuery(debouncedTitle, {
    skip: !debouncedTitle,
  });
